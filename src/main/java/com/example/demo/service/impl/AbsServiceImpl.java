...
public abstract class AbsServiceImpl<E extends BaseEntity, D extends DTO, R extends JpaRepository<E, Long>, M extends BaseMapper<E, D>>
        implements AbsService<E, D> {
